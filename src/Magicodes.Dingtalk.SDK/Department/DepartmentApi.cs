...
namespace Magicodes.Dingtalk.SDK.Department
{
    ...
    {
        public DepartmentApi(ILogger<DepartmentApi> logger, IServiceProvider serviceProvider) :
            base(logger,
                 serviceProvider) {
        }
        ...
        /// <returns></returns>
        public async Task<DepartmentResult> DepartmentList(string lang       = "zh_CN",
                                                           bool   fetchChild = true,
                                                           string id         = null) {
            ...
            return await Get<DepartmentResult>("department/list?access_token={ACCESS_TOKEN}",
                                               queryParameters);
        }
        ...
        public async Task<CreateOrUpdateDepartmentResult> Update(UpdateDepartmentInput input) {
            return await Post<CreateOrUpdateDepartmentResult>(
                       "department/update?access_token={ACCESS_TOKEN}", new {
                           lang                   = input.Lang,
                           name                   = input.Name,
                           parentid               = input.ParentId,
                           order                  = input.Order,
        ...
        public async Task<ApiResultBase> Delete(string id) {
            return await Get<ApiResultBase>(
                       "department/delete?access_token={ACCESS_TOKEN&}id=" + id);
        }
        ...
        /// <returns></returns>
        public async Task<GetDepartmentParentsListByDeptIdResult>
            GetSubDepartmentListIds(string id) {
            return await Get<GetDepartmentParentsListByDeptIdResult>(
                       "department/list_ids?access_token={ACCESS_TOKEN}&id=" + id);
        }
        ...
        /// <returns></returns>
        public async Task<GetDepartmentDetailsResult> GetDepartmentDetails(
            string id, string lang = "zh_CN") {
            return await Get<GetDepartmentDetailsResult>(
        ...
        /// <returns></returns>
        public async Task<GetDepartmentParentsListByDeptIdResult> GetDepartmentParentsListByDeptId(
            string id) {
            return await Get<GetDepartmentParentsListByDeptIdResult>(
                       "department/list_parent_depts_by_dept?access_token={ACCESS_TOKEN}&id=" + id);
        }
        ...
        /// <returns></returns>
        public async Task<GetDepartmentParentsListByUserIdResult> GetDepartmentParentsListByUserId(
            string userId) {
            return await Get<GetDepartmentParentsListByUserIdResult>(
                       "department/list_parent_depts?access_token={ACCESS_TOKEN}&userId=" + userId);
        }
    }
}