...
namespace Magicodes.Dingtalk.SDK.Cspace
{
    public class CspaceApi : ApiBase
    {
        ...
        public CspaceApi(ILogger<CspaceApi> logger, IServiceProvider serviceProvider) : base(
        ...
        public async Task<ApiResultBase> AddToSingleChat(AddToSingleChatInput input) {
            return await Post<ApiResultBase>(
                       "cspace/add_to_single_chat?access_token={ACCESS_TOKEN}", new {
        ...
        public async Task<GetCustomSpaceResult> GetCustomSpace(string domain, string agentId) {
            ...
            return await Get<GetCustomSpaceResult>(
                       "cspace/get_custom_space?access_token={ACCESS_TOKEN}", pairs);
        }
        ...
        public async Task<ApiResultBase> GrantCustomSpace(GrantCustomSpaceInput input) {
            ...
            return await Get<UesdInfoResult>(
                       "cspace/grant_custom_space?access_token={ACCESS_TOKEN}", pairs);
        }
    }
}